...
const StudentDashboard: React.FC<StudentDashboardProps> = ({
  ...
  const defaultMetrics = useMemo((): DashboardMetric[] => [
    ...
    },
    {
      ...
      value: courses.reduce((total, course) => total + (course.sessionsCompleted || 0), 0),
      change: 15,
      changeType: 'increase',
  ...
  const defaultQuickActions = useMemo((): QuickAction[] => [
    ...
    },
    {
      ...
      color: theme.colors.interactive.orange,
      onPress: () => console.log('My courses pressed'),
    },
    {
      id: 'achievements',
      title: 'Achievements',
  ...
  ), [displayMetrics, styles, handleMetricPressCallback, theme]);
